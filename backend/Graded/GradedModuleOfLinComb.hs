...
-- deriving instance (Show t, Monoid t, Semiring t, Eq t, Show a) => Monoid (GradedModuleOfLinComb t a)

-- instance (Monoid t, Show t, Semiring t, Eq t, Show a) => Semigroup (GradedModuleOfLinComb t a) where
